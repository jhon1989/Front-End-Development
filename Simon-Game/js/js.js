...
$(function(){
  ...
  if(!AudioContext) {
    ...
    // Alert your navigator not suppor Audio API
    ...
    // create Oscillators
    var oscillators = frequencies.map(function(freque) {
      var osc  = audioCtx.createOscillator();
      osc.type = 'sine';
      osc.frequency.value = freque;
      osc.start(0.0);
      return osc;
    });
    ...
    function notifyWin() {
      var cnt  = 0,
          last = gameStatus.lastPush.attr('id');
